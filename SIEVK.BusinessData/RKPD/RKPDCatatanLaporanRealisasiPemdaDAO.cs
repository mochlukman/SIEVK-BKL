...
{
    public class RKPDCatatanLaporanRealisasiPemdaDAO
    {        
        public DataTable GetCatatanLaporanRealisasi(string kdTahun, string kdTriwulan, string kdFAKTOR = null)
        {
            ...
            using (DataAccess db = new DataAccess())
            {
                ...
                dt = db.ExecuteDataTable("sp_RKPD_CatatanLaporanRealisasiPemdaList");
            }
            return dt;
        }
        ...
        public void Delete(string kdTahun, string kdTriwulan, string kdFAKTOR)
        {
            ...
            using (DataAccess db = new DataAccess())
            {
                ...
                db.AddParameter("KDTriwulan", SqlDbType.VarChar, kdTriwulan);
                db.AddParameter("KDFAKTOR", SqlDbType.VarChar, kdFAKTOR);
                db.ExecuteNonQuery("sp_RKPD_CatatanLaporanRealisasiPemdaDelete");
            }
        }
        ...
        public void Create(RKPDCatatanLaporanRealisasi realisasi)
        {
            ...
            using (DataAccess db = new DataAccess())
            {
                ...
                db.ExecuteNonQuery("sp_RKPD_CatatanLaporanRealisasiPemdaCreate");
            }
        }
        ...
        public void Update(RKPDCatatanLaporanRealisasi realisasi)
        {
            ...
            using (DataAccess db = new DataAccess())
            {
                ...
                db.AddParameter("NMCtt", SqlDbType.VarChar, realisasi.NMCTT);
                db.AddParameter("IsiCtt", SqlDbType.VarChar, realisasi.ISICTT);                
                db.ExecuteNonQuery("sp_RKPD_CatatanLaporanRealisasiPemdaUpdate");
            }
        }
