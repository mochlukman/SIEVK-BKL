...
{
    public class RKPDCatatanLaporanRealisasiSKPDService
    {
        Mapper map = new Mapper();
        RKPDCatatanLaporanRealisasiSKPDDAO dao = new RKPDCatatanLaporanRealisasiSKPDDAO();

        public List<RKPDCatatanLaporanRealisasi> GetCatatanLaporanRealisasiList(string unitKey, string kdTahun, string kdTriwulan)
        {
        ...
        public RKPDCatatanLaporanRealisasi GetCatatanLaporanRealisasi(string unitKey, string kdTahun, string kdTriwulan, string kdFAKTOR)
        {
