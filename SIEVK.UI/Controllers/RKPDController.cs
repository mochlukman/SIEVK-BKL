...
namespace SIEVK.Service.Controllers
{
    public class RKPDController : Controller
    {
        ...
        public ActionResult CatatanLaporanRealisasiPemdaCreate(string kdTahun, string kdTriwulan)
        {
            ...
            RKPDCatatanLaporanRealisasi realisasi = new RKPDCatatanLaporanRealisasi();
            try
            {
                ViewBag.Method = "Tambah";
        ...
        public ActionResult CatatanLaporanRealisasiPemdaCreate(FormCollection param)
        {
            ...
            try
            {
                ...
                {                    
                    ...
                    return RedirectToAction("CatatanLaporanRealisasiPemda", "RKPD", new { msg = GetValueFromResource("SUCCESS_INPUT"), kdTahun = catatan.KDTAHUN, kdTriwulan = catatan.KDTRWN });
                }
                else
                {
                    return CreateInputViewCatatanPemda(catatan, "true");
        ...
        public ActionResult CatatanLaporanRealisasiPemdaEdit(FormCollection param)
        {
            ...
            try
            {
                ...
                if (ValidateDataCatatanPemda(catatan, false))
                {
                    ...
                    return RedirectToAction("CatatanLaporanRealisasiPemda", "RKPD", new { msg = GetValueFromResource("SUCCESS_EDIT"), kdTahun = catatan.KDTAHUN, kdTriwulan = catatan.KDTRWN });
                }
                else
                {
                    return CreateInputViewCatatanPemda(catatan, "false");
        ...
        private ActionResult CreateInputViewCatatanPemda(RKPDCatatanLaporanRealisasi clr, string isCreate)
        {
        ...
        public bool ValidateDataCatatanPemda(RKPDCatatanLaporanRealisasi clr, bool isCreate)
        {
        ...
        private RKPDCatatanLaporanRealisasi BindDataToObjectCatatanPemda(FormCollection param, bool isCreate)
        {
            RKPDCatatanLaporanRealisasi catatan = new RKPDCatatanLaporanRealisasi();
        ...
        public ActionResult CatatanLaporanRealisasiSKPDCreate(FormCollection param)
        {
            ...
            try
            {
                ...
                if (ValidateDataCatatanSKPD(catatan, true))
                {
                    ...
                    return RedirectToAction("CatatanLaporanRealisasiSKPD", "RKPD", new { msg = GetValueFromResource("SUCCESS_INPUT"), unitKey = catatan.UNITKEY, kdTahun = catatan.KDTAHUN, kdTriwulan = catatan.KDTRWN });
                }
                else
                {
        ...
        public ActionResult CatatanLaporanRealisasiSKPDEdit(FormCollection param)
        {
            ...
            try
            {
                ...
                if (ValidateDataCatatanSKPD(catatan, false))
                {
                    ...
                    return RedirectToAction("CatatanLaporanRealisasiSKPD", "RKPD", new { msg = GetValueFromResource("SUCCESS_EDIT"), unitKey = catatan.UNITKEY, kdTahun = catatan.KDTAHUN, kdTriwulan = catatan.KDTRWN });
                }
                else
                {
                    return CreateInputViewCatatanSKPD(catatan, "false");
        ...
        private ActionResult CreateInputViewCatatanSKPD(RKPDCatatanLaporanRealisasi clr, string isCreate)
        {
            GenerateTahunAnggaranCombo(clr.KDTAHUN == null ? string.Empty : clr.KDTAHUN);
            GenerateTriwulanCombo(clr.KDTRWN == null ? string.Empty : clr.KDTRWN);
            GenerateJFaktorCombo(clr.KDFAKTOR == null ? string.Empty : clr.KDFAKTOR);
        ...
        public bool ValidateDataCatatanSKPD(RKPDCatatanLaporanRealisasi clr, bool isCreate)
        {
        ...
        private RKPDCatatanLaporanRealisasi BindDataToObjectCatatanSKPD(FormCollection param, bool isCreate)
        {
            RKPDCatatanLaporanRealisasi catatan = new RKPDCatatanLaporanRealisasi();
